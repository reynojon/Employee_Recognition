...
fileContents += '\\usepackage{lscape,graphicx,float}\n';
fileContents += '\n';
...
fileContents += '\begin{figure}[H]\n';
fileContents += '  \includegraphics[width=3in,height=1.5in]{./signature.png}\n';
fileContents += '  \centering\n';
fileContents += '\end{figure}\n';
fileContents += '\vspace{-0.5cm}{\rule[0.6in]{3in}{.1pt}}\n';
fileContents += '\vspace{-1.5cm}{\fontsize{12}{14}\selectfont \textbf{\\[.1mm]Presented by Some person}}\n';
//fileContents += '\\vspace{3cm}\n';
